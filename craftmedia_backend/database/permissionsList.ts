...
export const ALL_PERMISSIONS: PermissionDoc[] = [
  ...
  // ==================== WORK SESSIONS & RECORDINGS ====================
  {
    _id: 'perm_work_sessions_view',
    module: 'Work Sessions',
    action: 'View',
    code: 'work_sessions.view',
    name: 'View Work Sessions',
    description: 'View employee work sessions and daily activity summaries',
    category: 'People'
  },
  {
    _id: 'perm_work_sessions_manage',
    module: 'Work Sessions',
    action: 'Manage',
    code: 'work_sessions.manage',
    name: 'Manage Work Session Policies',
    description: 'Configure screen recording and work session parameters',
    category: 'People'
  },
  {
    _id: 'perm_view_employee_recording',
    module: 'Work Recordings',
    action: 'View',
    code: 'VIEW_EMPLOYEE_RECORDING',
    name: 'View Employee Work Recordings',
    description: 'Authorized streaming access to employee work screen & audio recordings',
    category: 'People'
  },
  {
    _id: 'perm_download_employee_recording',
    module: 'Work Recordings',
    action: 'Download',
    code: 'DOWNLOAD_EMPLOYEE_RECORDING',
    name: 'Download Employee Work Recordings',
    description: 'Authorized export and download of employee recording video segments',
    category: 'People'
  },
  {
    _id: 'perm_delete_employee_recording',
    module: 'Work Recordings',
    action: 'Delete',
    code: 'DELETE_EMPLOYEE_RECORDING',
    name: 'Delete Employee Work Recordings',
    description: 'Authorized deletion of stored work recording segments',
    category: 'People'
  }
];
